...
max-height: 40px;"/></a>';
	...
	<div id="container" style="background-color:#efefef; box-shadow:1px 1px 80px 20px rgba(20%,20%,20%,0.4) inset;"> 
      ...
      <ul class="breadcrumb" style="background-color: transparent; padding: 5px 15px;">
        ...
        <li><a href="gameboard.php" style="color:#aaa;">GameBoard(school)</a><span class="divider">/</span></li>
        <li class="active"><a style="color:#fff;">ScoreBoard(school)</a></li>
      </ul>
							<?php
        						try
        						{
						...
						<div style="float:right;">
							<a data-toggle="modal" href="#form-content1"
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="comments-logout">                
                    ...
                    ?>
                      <li class="media">
                        <a class="pull-left">
                          <img class="media-object img-circle" src="./img/head/p.jpg" alt="profile">
                        </a>
                        <div class="media-body">
                          <div class="well well-lg">
                              <h4 class="media-heading text-uppercase reviews">莊般若 </h4>
                      ...
                      <li class="media">
                        <a class="pull-left">
                          <img class="media-object img-circle" src="./img/head/17.jpg" alt="profile">
                        </a>
                        <div class="media-body">
                          <div class="well well-lg">
                              <h4 class="media-heading text-uppercase reviews">祖頓</h4>
                              <ul class="media-date text-uppercase reviews list-inline">
                                <li>22.09.2014</li> 
                              </ul>
                              <p class="media-comment">
                                對不起，我超雷。雷到大家的我不配和大家呼吸一樣的空氣。
                              </p>
                          </div>              
                        </div>
                      </li>
                      <li class="media">
                        <a class="pull-left">
                          <img class="media-object img-circle" src="./img/head/f.jpg" alt="profile">
                        </a>
                        <div class="media-body">
                          <div class="well well-lg">
                              <h4 class="media-heading text-uppercase reviews">稀奇</h4>
                              <ul class="media-date text-uppercase reviews list-inline">
                                <li>22.09.2014</li> 
                              </ul>
                              <p class="media-comment">
